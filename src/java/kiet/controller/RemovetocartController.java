 ...
 * @author keith
 */
@WebServlet(name = "RemovetocartController", urlPatterns = {"/RemovetocartController"})
public class RemovetocartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("RemoveController NullpointerEx " + e.getMessage());
            request.setAttribute("REMOVEERROR", "You have to choice item to remove");
        } finally {
            String url = "MainController?btnAction=View your cart";
